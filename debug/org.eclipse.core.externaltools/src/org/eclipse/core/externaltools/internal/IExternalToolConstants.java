...
public interface IExternalToolConstants {
	 ...
	 */
	ILaunchAttribute<String> LAUNCH_ATTRIBUTE_LOCATION = ILaunchAttribute.of(LAUNCH_ATTRIBUTE_IDENTITY_LOCATION, String.class, lc -> null, ExternalToolsProgramMessages.LaunchAttributeLocation_name);
	 ...
	 */
	ILaunchAttribute<String> LAUNCH_ATTRIBUTE_ARGUMENTS = ILaunchAttribute.of(LAUNCH_ATTRIBUTE_IDENTITY_ARGUMENTS, String.class, lc -> null, ExternalToolsProgramMessages.LaunchAttributeArguments_name);
	 ...
	 */
	ILaunchAttribute<String> LAUNCH_ATTRIBUTE_WORKING_DIRECTORY = ILaunchAttribute.of(LAUNCH_ATTRIBUTE_IDENTITY_WORKING_DIRECTORY, String.class, lc -> null, ExternalToolsProgramMessages.LaunchAttributeWorkingDirectory_name);
