...
public class InjectionErrorReportingTest {
	...
	public void testConstructorInjectionError() {
		...
		TestData methodValue = new TestData();
		context.set("testing", methodValue);
		assertThrows(InjectionException.class, () -> ContextInjectionFactory.make(InjectedConstructor.class, context));
	...
	public void testPreDestoryError() {
		...
		TestData methodValue = new TestData();
		context.set("testing", methodValue);
		assertThrows(InjectionException.class, () -> ContextInjectionFactory.make(InjectedPreDestroy.class, context));
		context.dispose();
	}
	...
	public void testRecursionError() {
		...
		assertThrows(StackOverflowError.class, () -> ContextInjectionFactory.make(InjectedRecursive.class, context));
	}
}
