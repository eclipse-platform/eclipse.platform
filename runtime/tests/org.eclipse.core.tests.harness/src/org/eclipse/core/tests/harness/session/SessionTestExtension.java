...
public class SessionTestExtension implements InvocationInterceptor {
	...
	/**
	 * Is set to true during remote execution to ensure that the JUnit 5 executor
	 * does not recursively make a remote call for executing the test
	 */
	...
	public void interceptTestMethod(Invocation<Void> invocation, ReflectiveInvocationContext<Method> invocationContext,
		...
		boolean isRemoteExecution = System.getProperty(REMOTE_EXECUTION_INDICATION_SYSTEM_PROPERY, "").equals(Boolean.toString(true));
		...
		invocation.skip();
		executeRemotely(testClass, testMethod, shouldFail);
	}

	private void executeRemotely(String testClass, String testMethod, boolean shouldFail) throws Throwable {
...
//		localSetup.setEclipseArgument("runasjunit5", "");
	 ...
	 */
	static class ResultCollector implements Runnable {
