...
public class CoreTest extends TestCase {
	...
	/**
	 * Asserts that a stream closes successfully. Null streams are ignored, but
	 * failure to close the stream is reported as an assertion failure.
	 *
	 * @since 3.2
	 */
	...
	/**
	 * Copy the data from the input stream to the output stream. Do not close either
	 * of the streams.
	 */
