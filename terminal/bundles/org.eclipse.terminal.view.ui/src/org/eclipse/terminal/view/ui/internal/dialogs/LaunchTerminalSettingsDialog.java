...
import org.eclipse.terminal.view.ui.controls.ConfigurationPanelControl;
	...
	protected List<String> getTerminals() {
		...
		if (selection == null || selection.isEmpty()) {
			...
			for (ILauncherDelegate delegate : delegates) {
				...
				if ("org.eclipse.terminal.connector.local.launcher.local".equals(delegate.getId())) { //$NON-NLS-1$
