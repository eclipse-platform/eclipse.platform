...
public class LauncherDelegateManager implements ILauncherDelegateManager {
	 ...
	 * <ul><li>Extensions contributed by our own plug-ins (<code>org.eclipse.terminal.*</code>)
	...
	/* default */ static class ExtensionPointComparator implements Comparator<IExtension> {
		private final static String OWN_PLUGINS_PATTERN = "org.eclipse.terminal."; //$NON-NLS-1$
