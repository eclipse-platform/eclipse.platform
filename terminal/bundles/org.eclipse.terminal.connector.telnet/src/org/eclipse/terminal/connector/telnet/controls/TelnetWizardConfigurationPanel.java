 ...
 *******************************************************************************/
package org.eclipse.terminal.connector.telnet.controls;
...
import org.eclipse.terminal.connector.telnet.connector.NetworkPortMap;
...
public class TelnetWizardConfigurationPanel extends AbstractExtendedConfigurationPanel {
	...
	public void extractData(Map<String, Object> data) {
		...
		data.put(ITerminalsConnectorConstants.PROP_TERMINAL_CONNECTOR_ID,
				"org.eclipse.terminal.connector.telnet.TelnetConnector"); //$NON-NLS-1$
