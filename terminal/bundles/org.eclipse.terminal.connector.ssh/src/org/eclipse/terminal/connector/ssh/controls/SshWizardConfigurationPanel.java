 ...
 *******************************************************************************/
package org.eclipse.terminal.connector.ssh.controls;
...
import org.eclipse.terminal.connector.ssh.connector.SshConnector;
...
public class SshWizardConfigurationPanel extends AbstractExtendedConfigurationPanel {
	...
	public void extractData(Map<String, Object> data) {
		...
		data.put(ITerminalsConnectorConstants.PROP_TERMINAL_CONNECTOR_ID,
				"org.eclipse.terminal.connector.ssh.SshConnector"); //$NON-NLS-1$
