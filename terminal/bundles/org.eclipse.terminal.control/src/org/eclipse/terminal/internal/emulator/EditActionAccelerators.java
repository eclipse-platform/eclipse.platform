...
class EditActionAccelerators {
	private static final String COPY_COMMAND_ID = "org.eclipse.terminal.copy"; //$NON-NLS-1$
	private static final String PASTE_COMMAND_ID = "org.eclipse.terminal.paste"; //$NON-NLS-1$
